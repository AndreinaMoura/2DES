...
LOAD DATA INFILE 'C:/Users/Desenvolvimento/Desktop/logic2/Back-end/aula4/academia/docs/aparelhos.csv'
...
LOAD DATA INFILE 'C:/Users/Desenvolvimento/Desktop/logic2/Back-end/aula4/academia/docs/exercicio.csv'
...
LOAD DATA INFILE 'C:/Users/Desenvolvimento/Desktop/logic2/Back-end/aula4/academia/docs/fichaExerc.csv'
INTO TABLE fichas
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\r\n'
...
-- Criando a Visão com alunos e telefones juntos
create view vw_alunos as
select c.id_aluno, c.nome, c.nascimento, c.sexo, c.peso, t.numero as telefones from alunos c
